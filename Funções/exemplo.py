...
print("o resultado de uma funcao", resultadoSoma)
print("o resultado de uma funcao", resultadoSubtracao)
print("o resultado de uma funcao", resultadoMultiplicacao)
print("o resultado de uma funcao", resultadoDivisao)